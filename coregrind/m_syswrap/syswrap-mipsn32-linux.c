...
ULong do_syscall_clone_mipsn32_linux ( Word (*fn) (void *),  /* a0 - 4 */
                                      void* stack,          /* a1 - 5 */
                                      Int   flags,          /* a2 - 6 */
                                      void* arg,            /* a3 - 7 */
                                      Int*  parent_tid,     /* a4 - 8 */
...
".set noreorder\n"
".set nomacro\n"
".globl do_syscall_clone_mipsn32_linux\n"
"do_syscall_clone_mipsn32_linux:\n"
"   daddiu $29, $29, -32\n"
"   sd $31, 0($29)\n"
"   sd $30, 8($29)\n"
"   sd $28, 16($29)\n"
                         ...
                         Addr child_tls )
{
   ...
   ret = do_syscall_clone_mipsn32_linux(ML_(start_thread_NORETURN),
